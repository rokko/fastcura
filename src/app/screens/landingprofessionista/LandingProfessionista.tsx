 ...
 Superati i 60 giorni ti costa meno di un caffè al giorno,solo 19,90 al mese</p>
    ...
    return (
      <>
        <div style={{ backgroundColor: "rgb(246, 246, 246)" }}>
          <Header />
          <ContainerFirstImage style={{backgroundColor:'white'}}>
            <TitleFirstContainer>
              Iscriviti a <SpanTitle>Fastcura</SpanTitle>
            </TitleFirstContainer>
            <img src={PrimaImmagine} alt='prima' width={'100%'}/>
            <Link
              to="/signup-professionista"
              style={{ textDecoration: "none" }}
            >
          ...
          <TitleSection>Come funziona</TitleSection>
          <div style={{display:'flex', flexDirection:'column', gap:'3rem', alignContent:'center', alignItems:'center'}}>
          <NewBox>
                <img src={Visibilita} width={"276px"} height={"138px"} />
                <NewTesto>
                Migliora la tua visibilità
          ...
          <div style={{display:'flex', flexDirection:'column', gap:'3rem', alignContent:'center', alignItems:'center', marginTop:'3rem'}}>
              <NewBox>
                <img src={Messaggistica} width={"198px"} height={"198px"} />
                <NewTesto>
                Messaggia direttamente<br/> con il cliente</NewTesto>
              ...
              style={{ textDecoration: "none" }}
            >
              <TitleFinal style={{ fontSize: "33px", marginBottom: "0px" }}>
                Provalo gratis!
              </TitleFinal>
              <p style={{fontFamily:'Helvetica', fontWeight:'400', fontSize:'23px', color:'black'}}>Un Nuovo Modo di Far Crescere la Tua Carriera nella Sanità</p>
              <p style={{fontFamily:'Helvetica', fontWeight:'400', fontSize:'16px', color:'black'}}>Sei un infermiere, fisioterapista o caregiver?<br/>
Prova Fastcura gratuitamente per 60 giorni! <br/>
<br/>
<br/>
...
🚀 Fai crescere tua carriera.<br/>
 ...
 Superati i 60 giorni ti costa meno di un caffè al giorno,solo 19,90 al mese</p>
            ...
            <Link
              to="/signup-professionista"
              style={{ textDecoration: "none" ,display:'flex', flexDirection:'column', alignContent:'center', alignItems:'center'}}
            >
              <FinalButton style={{textAlign:'center'}}>Inizia ora la prova gratuita</FinalButton>
            </Link>
