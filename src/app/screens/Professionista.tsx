...
useEffect(()=>{
    ...
    return(
        ...
        <div style={{backgroundColor:'#ffffff', borderRadius:'50%', width:'100px', height:'100px', marginTop:'-50px',border:"1px solid #39B1D9", borderStyle:'solid',borderWidth:'1px',display:'flex', alignItems:'center',alignContent:'center', justifyContent:'center'}}>
        ...
        <button style={{display:'flex', alignItems:'center', justifyContent:'center' ,marginTop:'10px',textAlign:'center',width:'255px', backgroundColor:(scelta==='Curriculum')?'#ffffff' :'#39B1D9', height:'40px', borderRadius:'30px',border:(scelta==='Curriculum')?'1px solid #39B1D9' :'none', color:'white', fontWeight:'bold', fontSize:'17px', }} onClick={()=>setScelta('Curriculum')}><p style={{color:(scelta==='Curriculum')?'#39B1D9':'white'}}>Aggiorna Curriculum</p></button>
        <button style={{display:'flex', alignItems:'center', justifyContent:'center' ,marginTop:'10px',textAlign:'center',width:'255px', backgroundColor:(scelta==='Abbonamenti')?'#ffffff' :'#39B1D9', height:'40px', borderRadius:'30px',border:(scelta==='Abbonamenti')?'1px solid #39B1D9' :'none', color:'white', fontWeight:'bold', fontSize:'17px', }} onClick={()=>setScelta('Abbonamenti')}><p style={{color:(scelta==='Abbonamenti')?'#39B1D9':'white'}}>Piano Abbonamento</p></button>
        </div>
