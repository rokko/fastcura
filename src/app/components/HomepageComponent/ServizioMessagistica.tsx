              ...
              >
                ...
                <Fade direction={"up"}>
                  <Typography
                    ...
                    marginBottom={10}
                  >
                    La persona trova i professionisti più vicini a lui e ne
                    valuta le competenze e la qualità dei servizi erogati
                    attraverso le recensioni lasciate da altri utenti
                  </Typography>
                </Fade>
              </div>
              <svg
