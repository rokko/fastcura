...
const BoxChat = (props: any) => {
  ...
  useEffect(() => {
    recuperaChat();
    const prof = {
      id_professionista: props.contatto.professionista_id,
    };
    axios
      .post(
        "https://fastcuradev.herokuapp.com/professionista/find-avatar",
        prof
      )
      .then((response: any) => {
        console.log("ciao");
  ...
  return (
    <>
      ...
      >
        ...
        {avatar !== "" && (
          <img src={avatar} alt="avatar" width={"25px"} height={"25px"} />
        )}
        <p style={{ color: "blue", width: "70%", textAlign: "left" }}>
