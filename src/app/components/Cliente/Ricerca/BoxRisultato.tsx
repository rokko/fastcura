          ...
          >
            <div style={{ display: "flex", flexDirection: "row" }}>
              <svg
                ...
                width="17.547"
                height="26.667"
                viewBox="0 0 17.547 26.667"
              >
                <path
                  id="Icon_ionic-ios-pin"
                  data-name="Icon ionic-ios-pin"
                  d="M16.648,3.375a8.676,8.676,0,0,0-8.773,8.571c0,6.667,8.773,18.1,8.773,18.1s8.773-11.429,8.773-18.1A8.676,8.676,0,0,0,16.648,3.375Zm0,12.237a2.935,2.935,0,0,1-2.857-3.006,2.861,2.861,0,1,1,5.715,0A2.935,2.935,0,0,1,16.648,15.612Z"
